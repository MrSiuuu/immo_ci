          ...
          <div className="mx-auto w-full max-w-md">
            <div className="mb-10 flex items-center gap-3">
              ...
              <div>
                ...
                <span className="mt-0.5 block text-xs text-[#E02020]/75">Espace professionnel</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-white/15 bg-white/8 px-3 py-2.5 text-white placeholder:text-white/35 focus:outline-none focus:ring-2 focus:ring-[#E02020] dark:border-white/20 dark:bg-white/10"
                />
              </div>
              <div>
